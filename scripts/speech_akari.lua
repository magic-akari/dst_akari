...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Akari is not going to try that while he's awake.",
			GENERIC = "Akari can't shave that!",
		...
		STORE =
		{
			...
			INUSE = "Akari should wait my turn.",
		},
		RUMMAGE =
		{
			GENERIC = "Akari can't do that.",
			INUSE = "Akari should wait my turn.",
		},
        COOK =
        {
        ...
        GIVE =
        {
            DEAD = "Maybe Akari'll just hold on to this.",
            SLEEPING = "Too unconscious to care.",
            BUSY = "Akari'll try again in a second.",
        },
        GIVETOPLAYER =
        {
        ...
        ATTUNE =
        {
            NOHEALTH = "Akari don't feel well enough.",
        },
	},
	ACTIONFAIL_GENERIC = "Akari can't do that.",
	ANNOUNCE_ADVENTUREFAIL = "That didn't go well. Akari'll have to try again.",
	ANNOUNCE_BEES = "BEEEEEEEEEEEEES!!!!",
	ANNOUNCE_BOOMERANG = "Ow! Akari should try to catch that!",
	...
	ANNOUNCE_CRAFTING_FAIL = "Akari don't have all of the ingredients.",
	ANNOUNCE_DEERCLOPS = "That sounded big!",
	ANNOUNCE_DUSK = "It's getting late. It will be dark soon.",
	ANNOUNCE_EAT =
	{
		GENERIC = "Yum!",
		PAINFUL = "Akari don't feel so good.",
		SPOILED = "Yuck! That was terrible!",
		STALE = "Akari think that was starting to turn.",
		INVALID = "Akari can't eat that!",
		YUCKY = "Puting that in my mouth would be disgusting!",
	},
	ANNOUNCE_ENTER_DARK = "It's so dark!",
	ANNOUNCE_ENTER_LIGHT = "Akari can see again!",
	ANNOUNCE_FREEDOM = "Akari is free! Akari is finally free!",
	ANNOUNCE_HIGHRESEARCH = "Akari feel so smart now!",
	ANNOUNCE_HOUNDS = "Did you hear that?",
	ANNOUNCE_WORMS = "Did you feel that?",
	ANNOUNCE_HUNGRY = "Akari is so hungry!",
	...
	ANNOUNCE_INV_FULL = "Akari can't carry any more stuff!",
	ANNOUNCE_KNOCKEDOUT = "Ugh, my head!",
	ANNOUNCE_LOWRESEARCH = "Akari didn't learn very much from that.",
	...
	ANNOUNCE_NODAYSLEEP_CAVE = "Akari is not tired.",
	ANNOUNCE_NOHUNGERSLEEP = "Akari is too hungry to sleep, the growling will keep me up!",
	...
	ANNOUNCE_NONIGHTSIESTA_CAVE = "Akari don't think Akari could really relax down here.",
	ANNOUNCE_NOHUNGERSIESTA = "Akari is too hungry for a siesta!",
	...
	ANNOUNCE_UNIMPLEMENTED = "OW! Akari don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "That was not a sane thing to do.",
	ANNOUNCE_CANFIX = "\nI think Akari can fix this!",
	ANNOUNCE_ACCOMPLISHMENT = "Akari feel so accomplished!",
	...
	ANNOUNCE_SOAKED = "Akari've nearly reached my saturation point.",
	...
	BATTLECRY =
	{
		...
		PREY = "Akari will destroy you!",
		SPIDER = "Akari is going to stomp you dead!",
		SPIDER_WARRIOR = "Better you than me!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "Akari sure showed him!",
		PIG = "Akari'll let him go. This time.",
		PREY = "He's too fast!",
	...
	DESCRIBE =
	{
        ...
        MIGRATION_PORTAL = {
            GENERIC = "If Akari had any friends, this could take me to them.",
            OPEN = "If Akari step through, will Akari still be me?",
		...
		STATUEGLOMMER =
		{
			GENERIC = "Akari is not sure what that's supposed to be.",
			EMPTY = "Akari broke it. For science.",
		},
		...
		MOLE =
		{
			...
			ABOVEGROUND = "Akari'd sure like to whack that mole... thing.",
		},
		...
		UNAGI = "Akari cooked it myself!",
		EYETURRET = "Akari hope it doesn't turn on me.",
		EYETURRET_ITEM = "Akari think it's sleeping.",
		MINOTAURHORN = "Wow! Akari is glad that didn't gore me!",
		...
		THULECITE = "Akari wonder where this is from?",
		...
		NIGHTMARE_TIMEPIECE =
		{
            ...
            WAXING = "Akari think it's becoming more concentrated!",
		...
		NIGHTMARELIGHT = "Akari wonder what function this served.",
		...
		GREENAMULET = "Just when Akari thought Akari couldn't get any better.",
		...
		YELLOWSTAFF = "Akari put a gem on a stick.",
		...
		COMPASS =
		{
			GENERIC="Which way am Akari facing?",
			N = "North",
			S = "South",
			E = "East",
			W = "West",
		...
		BATBAT = "Akari wonder if Akari could fly with two of these.",
		BATWING="Akari hate these things, even when they're dead.",
		BATWING_COOKED="At least it's not coming back.",
        BATCAVE = "Akari don't want to wake them.",
		BEDROLL_FURRY="It's so warm and comfy.",
		BUNNYMAN="Akari am filled with an irresitable urge to do science.",
		...
		MANRABBIT_TAIL="Akari just like holding it.",
		MUSHTREE_TALL = {
		...
		MUSHTREE_MEDIUM = {
            ...
            BLOOM = "Akari is mildly offended by this.",
        },
		MUSHTREE_SMALL = {
        ...
        SPORE_TALL_INV = "Akari'll keep a little light in my pocket.",
        SPORE_MEDIUM_INV = "Akari'll keep a little light in my pocket.",
        SPORE_SMALL_INV = "Akari'll keep a little light in my pocket.",
		RABBITHOUSE=
		{
		...
		SLURTLEHAT="Akari hope it doesn't mess up my hair.",
		SLURTLEHOLE="A den of 'ew'.",
		SLURTLESLIME="If it wasn't useful, Akari wouldn't touch it.",
		SNURTLE="He's less gross, but still gross.",
		SPIDER_HIDER="Gah! More spiders!",
		SPIDER_SPITTER="Akari hate spiders!",
		...
		POWCAKE = "Akari don't know if Akari is hungry enough.",
        CAVE_ENTRANCE = "Akari wonder if Akari could move that rock.",
        CAVE_ENTRANCE_RUINS = "It's probably hiding something.",
        CAVE_ENTRANCE_OPEN = {
            GENERIC = "The earth itself rejects me!",
            OPEN = "Akari bet there's all sorts of things to discover down there.",
            FULL = "Akari'll have to wait until someone leaves.",
        },
        CAVE_EXIT = {
            GENERIC = "Akari'll just stay down here, Akari suppose.",
            OPEN = "Akari've had enough discovery for now.",
		...
		ADVENTURE_PORTAL = "Akari is not sure Akari want to fall for that a second time.",
		AMULET = "Akari feel so safe when Akari is wearing it.",
		ANIMAL_TRACK = "Tracks left by food. Akari mean... an animal.",
		ARMORGRASS = "Akari hope there are no bugs in this.",
		...
		ASH =
		{
			...
			REMAINS_GLOMMERFLOWER = "The flower was consumed by fire when Akari teleported!",
			REMAINS_EYE_BONE = "The eyebone was consumed by fire when Akari teleported!",
		...
		BACONEGGS = "Akari cooked it myself!",
		BANDAGE = "Seems sterile enough.",
		BASALT = "That's too strong to break through!",
		BATBAT = "Akari bet Akari could fly if Akari held two of these.",	-- Duplicated
		BEARDHAIR = "Akari made them with my face.",
		...
		BEEBOX =
		{
			...
			GENERIC = "Bees!",
			NOHONEY = "It's empty.",
			SOMEHONEY = "Akari should wait a bit.",
		...
		BEEMINE = "It buzzes when Akari shake it.",
		BEEMINE_MAXWELL = "Bottled mosquito rage!",
		BERRIES = "Red berries taste the best.",
		BERRIES_COOKED = "Akari don't think heat improved them.",
		BERRYBUSH =
		{
			BARREN = "Akari think it needs to be fertilized.",
		...
		BLUE_MUSHROOM =
		{
			...
			PICKED = "Akari wonder if it will come back?",
		},
		BOARDS = "Boards.",
		BOAT = "Is that how Akari got here?",
		BONESHARD = "Bits of bone.",
		BONESTEW = "Akari cooked it myself!",
		BUGNET = "For catching bugs.",
		BUSHHAT = "It's kind of scratchy.",
		BUTTER = "Akari can't believe it's butter!",
		BUTTERFLY =
		{
			GENERIC = "Butterfly, flutter by.",
			HELD = "Now Akari have you!",
		},
		BUTTERFLYMUFFIN = "Akari cooked it myself!",
		...
		COLDFIRE =
		{
			EMBERS = "Akari should put something on the fire before it goes out.",
		...
		CATCOONHAT = "Ears hat!",
		COONTAIL = "Akari think it's still swishing.",
		...
		COOKEDSMALLMEAT = "Now Akari don't have to worry about getting worms!",
		COOKPOT =
		{
		...
		CUTSTONE = "Akari've made them seductively smooth.",
		...
		DEVTOOL_NODEV = "Akari is not strong enough to wield it.",
		...
		DIVININGROD =
		{
			...
			WARM = "Akari is headed in the right direction.",
			WARMER = "Akari must be getting pretty close.",
		},
		DIVININGRODBASE =
		{
			GENERIC = "Akari wonder what it does.",
		...
		{
			HOT = "Hot spit!",
			COOL = "Akari like to call it 'Basaliva'.",
		},
		...
		LAVAE_PET =
		{
			...
			HUNGRY = "Akari hear a tiny stomach grumbling.",
			CONTENT = "It seems happy.",
			GENERIC = "Aww. Who's a good monster?",
		},
		LAVAE_EGG =
		{
			GENERIC = "Akari can feel a faint warmth coming from inside.",
		},
		LAVAE_EGG_CRACKED =
		{
			COLD = "Akari don't think that egg is warm enough.",
			COMFY = "Akari never thought Akari would see a happy egg.",
		},
		...
		DRAGONPIE = "Akari cooked it myself!",
		DRUMSTICK = "Akari should gobble it.",
		DRUMSTICK_COOKED = "Now it's even tastier.",
		DUG_BERRYBUSH = "Akari should plant this.",
		DUG_GRASS = "Akari should plant this.",
		DUG_MARSH_BUSH = "Akari should plant this.",
		DUG_SAPLING = "Akari should plant this.",
		DURIAN = "Oh it smells!",
		...
		DECIDUOUSTREE =
		{
			...
			BURNT = "Akari feel like Akari could have prevented that.",
		...
		EYEPLANT = "Akari think Akari is being watched.",
		FARMPLOT =
		{
			GENERIC = "Akari should try planting some crops.",
			GROWING = "Go plants go!",
			NEEDSFERTILIZER = "Akari think it needs to be fertilized.",
			BURNT = "Akari don't think anything will grow in a pile of ash.",
		},
		FEATHERHAT = "Akari AM A BIRD!",
		...
		FIREFLIES =
		{
			GENERIC = "If only Akari could catch them!",
		...
		FIREPIT =
		{
			...
			LOW = "The fire's getting a bit low.",
			NORMAL = "Nice and comfy.",
			OUT = "At least Akari can start it up again.",
		},
		COLDFIREPIT =
		{
			EMBERS = "Akari should put something on the fire before it goes out.",
		...
		FIRESTAFF = "Akari don't want to set the world on fire.",
		FIRESUPPRESSOR =
		{
			ON = "Fling on!",
		...
		FROGGLEBUNWICH = "Akari cooked it myself!",
		FROGLEGS = "Akari've heard it's a delicacy.",
		FROGLEGS_COOKED = "Tastes like chicken.",
		FRUITMEDLEY = "Akari cooked it myself!",
		...
		GOLDENPITCHFORK = "Why did Akari even make a pitchfork this fancy?",
		GOLDENSHOVEL = "Akari can't wait to dig holes.",
		GOLDNUGGET = "Akari can't eat it, but it sure is shiny.",
		GRASS =
		{
		...
		HEATROCK =
		{
			...
			GENERIC = "Akari could manipulate its temperature.",
		...
		HONEYHAM = "Akari cooked it myself!",
		HONEYNUGGETS = "Akari cooked it myself!",
		HORN = "It sounds like a beefalo field in there.",
		HOUND = "You ain't nothing, hound dog!",
		HOUNDBONE = "Creepy.",
		HOUNDMOUND = "Akari wouldn't want to pick a bone with the owner.",
		ICEBOX = "Akari have harnessed the power of cold!",
		...
		JAMMYPRESERVES = "Akari cooked it myself!",
		KABOBS = "Akari cooked it myself!",
		KILLERBEE =
		{
		...
		LIGHTNING_ROD =
		{
			...
			GENERIC = "Akari can harness the heavens!",
		},
		LIGHTNINGGOAT =
		{
			GENERIC = "'Baaaah' yourself!",
			CHARGED = "Akari don't think it liked being struck by lightning.",
		},
		...
		LUREPLANTBULB = "Now Akari can start my very own meat farm.",
		MALE_PUPPET = "He's trapped!",

		MANDRAKE_ACTIVE = "Stop following me!",
		MANDRAKE_PLANTED = "Akari've heard strange things about those plants.",
		MANDRAKE = "A mandrake root has strange powers.",

		MANDRAKESOUP = "Akari cooked it myself!",
		MANDRAKE_COOKED = "It doesn't seem so strange anymore.",
		MARBLE = "Fancy!",
		MARBLEPILLAR = "Akari think Akari could use that.",
		MARBLETREE = "Akari don't think an axe will cut it.",
		MARSH_BUSH =
		{
			BURNING = "That's burning fast!",
		...
		MAXWELL = "Akari hate that guy.",
		MAXWELLHEAD = "Akari can see into his pores.",
		MAXWELLLIGHT = "Akari wonder how they work.",
		...
		MERMHEAD =
		{
			GENERIC = "The stinkiest thing Akari'll smell all day.",
		...
		MONSTERLASAGNA = "Akari cooked it myself!",
		FLOWERSALAD = "A bowl of foliage.",
        ICECREAM = "Akari scream for ice cream!",
        WATERMELONICLE = "Cryogenic watermelon.",
        TRAILMIX = "A healthy, natural snack.",
        HOTCHILI = "Five alarm!",
        GUACAMOLE = "Avogadro's favorite dish.",
		MONSTERMEAT = "Ugh. Akari don't think Akari should eat that.",
		MONSTERMEAT_DRIED = "Strange-smelling jerky.",
		MOOSE = "Akari don't exactly know what that thing is.",
		...
		MOUND =
		{
			DUG = "Akari should probably feel bad about that.",
			GENERIC = "Akari bet there's all sorts of good stuff down there!",
		},
		NIGHTLIGHT = "It gives off a spooky light.",
		NIGHTMAREFUEL = "This stuff is crazy!",
		NIGHTSWORD = "Akari dreamed it myself!",
		NITRE = "Akari is not a geologist.",
		ONEMANBAND = "Akari should have added a beefalo bell.",
		PANDORASCHEST = "It may contain something fantastic! Or horrible.",
		PANFLUTE = "Akari can serenade the animals.",
		PAPYRUS = "Some sheets of paper.",
		PENGUIN = "Must be breeding season.",
		PERD = "Stupid bird! Stay away from my berries!",
		PEROGIES = "Akari cooked it myself!",
		PETALS = "Akari showed those flowers who's boss!",
		PETALS_EVIL = "Akari is not sure Akari want to hold these.",
		PHLEGM = "It's thick and pliable. And salty.",
		PICKAXE = "Iconic, isn't it?",
		PIGGYBACK = "Akari feel kinda bad for that.",
		PIGHEAD =
		{
		...
		PIGHOUSE =
		{
			FULL = "Akari can see a snout pressed up against the window.",
			GENERIC = "These pigs have pretty fancy houses.",
			LIGHTSOUT = "Come ON! Akari know you're home!",
		...
		PINECONE = "Akari can hear a tiny tree inside it, trying to get out.",
		...
		POND = "Akari can't see the bottom!",
		POOP = "Akari should fill my pockets!",
		FERTILIZER = "That is definitely a bucket full of poop.",
		PUMPKIN = "It's as big as my head!",
		PUMPKINCOOKIE = "Akari cooked it myself!",
		...
		RAINHAT = "It'll mess up my hair, but Akari'll stay nice and dry.",
		RATATOUILLE = "Akari cooked it myself!",
		...
		REEDS =
		{
			...
			PICKED = "Akari picked all the useful reeds.",
		},
        RELIC =
        {
		...
		RESEARCHLAB3 =
		{
			GENERIC = "What have Akari created?",
		...
		ICE = "Ice to meet you.",
		ROCKS = "Akari can make stuff with these.",
		...
		SEEDS_COOKED = "Akari cooked all the life out of 'em!",
		...
		SKULLCHEST = "Akari is not sure if Akari want to open it.",
		SMALLBIRD =
		{
		...
		{
			DEAD = "Ewwww!",
			GENERIC = "Akari hate spiders.",
			SLEEPING = "Akari'd better not be here when he wakes up.",
		},
		SPIDERDEN = "Sticky!",
		SPIDEREGGSACK = "Akari hope these don't hatch in my pocket.",
		SPIDERGLAND = "It has a tangy, antiseptic smell.",
		SPIDERHAT = "Akari hope Akari got all of the spider goo out of it.",
		SPIDERQUEEN = "AHHHHHHHH! That spider is huge!",
		SPIDER_WARRIOR =
		{
			DEAD = "Good riddance!",
			GENERIC = "Looks even meaner than usual.",
			SLEEPING = "Akari should keep my distance.",
		},
		...
		STUFFEDEGGPLANT = "Akari cooked it myself!",
		...
		TALLBIRDEGG_CRACKED =
		{
			...
			LONG = "Akari have a feeling this is going to take a while...",
		...
		TEENBIRD =
		{
			...
			HUNGRY = "Akari'd better find it some food.",
		...
		TELEPORTATO_BASE =
		{
			ACTIVE = "With this Akari can surely pass through space and time!",
		...
		TENT =
		{
			GENERIC = "Akari get crazy when Akari don't sleep.",
		...
		TENTACLESPOTS = "Akari think these were its genitalia.",
		...
		TRAP = "Akari wove it real tight.",
		TRAP_TEETH = "This is a nasty surprise.",
		TRAP_TEETH_MAXWELL = "Akari'll want to avoid stepping on that!",
		TREASURECHEST =
		{
		...
		TRINKET_7 = "Akari have no time for fun and games!", --Ball and Cup
		TRINKET_8 = "Great. All of my tub stopping needs are met.", --Hardened Rubber Bung
		TRINKET_9 = "Akari is more of a zipper person, myself.", --Mismatched Buttons
		TRINKET_10 = "Akari hope Akari get out of here before Akari need these.", --Second-hand Dentures
		TRINKET_11 = "He whispers beautiful lies to me.", --Lying Robot
		TRINKET_12 = "Akari is not sure what Akari should do with a dessicated tentacle.", --Dessicated Tentacle
		TRINKET_13 = "It must be some kind of religious artifact.", --Gnomette
		TRINKET_14 = "Now if Akari only had some tea...", -- Leaky Teacup
		...
		TRINKET_18 = "Akari wonder what it's hiding?", -- Toy Trojan Horse
		TRINKET_19 = "It doesn't spin very well.", -- Unbalanced Top
		TRINKET_20 = "Now Akari can scratch my back; all my problems are solved!", -- Back Scratcher
		...
		TRINKET_23 = "Akari can put my shoes on without help, thanks.", -- Shoe Horn
		...
		TRINKET_27 = "Good, Akari can hang my clothes up if Akari ever find a hook.", -- Wire Hanger
		...
		WAFFLES = "Akari cooked it myself!",
		WALL_HAY =
		{
			GENERIC = "Hmmmm. Akari guess that'll have to do.",
		...
		WALRUS_TUSK = "Akari is sure Akari'll find a use for it eventually.",
		WARDROBE =
		{
			GENERIC = "Maybe Akari can be even more handsome!",
            BURNING = "That's burning fast!",
			BURNT = "So long, style.",
		},
		WARG = "You might be something to reckon with, big dog.",
		WASPHIVE = "Akari think those bees are mad.",
		WATERMELON = "Sticky sweet.",
		WATERMELON_COOKED = "Juicy and warm.",
		WATERMELONHAT = "Let the juice run down your face.",
		WETGOOP = "Akari cooked it myself!",
		WINTERHAT = "It'll be good for when winter comes.",
		WINTEROMETER =
		{
			GENERIC = "Akari am one heck of a scientist.",
		...
		ACCOMPLISHMENT_SHRINE = "Akari want to use it, and Akari want the world to know what Akari did.",
		...
		HUMANMEAT = "Flesh is flesh. Where do Akari draw the line?",
